...
<span class="py-function">saluer</span>(<span class="py-variable">heure_journee</span><span class="py-operator">=</span><span class="py-string">"nuit"</span>, <span class="py-variable">nom</span><span class="py-operator">=</span><span class="py-string">"Léa"</span>)</code></pre></div></div></div>
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 3 : Somme de Nombres</h4><p class="text-gray-700 mb-4">Écrivez une fonction <code>calculer_somme</code> qui prend une liste de nombres en argument et retourne leur somme. Vous pouvez utiliser une boucle <code>for</code>.</p><button hidden  onclick="toggleSolution('sol_func_3')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_func_3" class="solution"><div class="code-block"><pre><code><span class="py-keyword">def</span> <span class="py-function">calculer_somme</span>(<span class="py-variable">liste_nombres</span>):
...
<span class="py-function">print</span>(<span class="py-function">calculer_somme</span>([<span class="py-number">10</span>, <span class="py-number">20</span>])) <span class="py-comment"># Devrait afficher 30</span></code></pre></div></div></div>
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 4 : Vérificateur de Parité</h4><p class="text-gray-700 mb-4">Écrivez une fonction <code>verifier_parite</code> qui prend un entier et retourne la chaîne de caractères "Pair" si le nombre est pair, et "Impair" sinon.</p><button hidden  onclick="toggleSolution('sol_func_4')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_func_4" class="solution"><div class="code-block"><pre><code><span class="py-keyword">def</span> <span class="py-function">verifier_parite</span>(<span class="py-variable">nombre</span>):
...
<span class="py-function">print</span>(<span class="py-function">verifier_parite</span>(<span class="py-number">3</span>))  <span class="py-comment"># Devrait afficher "Impair"</span></code></pre></div></div></div>
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 5 : Calcul de la Factorielle</h4><p class="text-gray-700 mb-4">Créez une fonction <code>calculer_factorielle</code> qui prend un entier non négatif <code>n</code> et retourne sa factorielle (<code>n!</code>). La factorielle de 0 est 1.</p><button hidden  onclick="toggleSolution('sol_func_5')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_func_5" class="solution"><div class="code-block"><pre><code><span class="py-keyword">def</span> <span class="py-function">calculer_factorielle</span>(<span class="py-variable">n</span>):
...
<span class="py-function">print</span>(<span class="py-function">calculer_prix_ttc</span>.<span class="py-variable">__doc__</span>)</code></pre></div></div>
        ...
        <div id="exercices-docstrings" class="mt-16"><h3 class="text-2xl font-semibold mb-4">Série d'Exercices sur les Docstrings</h3><div class="space-y-6">
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 1 : Documenter une fonction simple</h4><p class="text-gray-700 mb-4">Ajoutez une docstring sur une seule ligne à la fonction suivante : `def afficher_ligne(): print("-" * 20)`</p><button hidden  onclick="toggleSolution('sol_doc_1')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_doc_1" class="solution"><div class="code-block"><pre><code><span class="py-keyword">def</span> <span class="py-function">afficher_ligne</span>():
    ...
    print(f"Bonjour, {nom} !")</code></pre><button hidden  onclick="toggleSolution('sol_doc_2')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_doc_2" class="solution"><div class="code-block"><pre><code><span class="py-keyword">def</span> <span class="py-function">saluer</span>(<span class="py-variable">nom</span>):
    ...
    return a + b</code></pre><button hidden  onclick="toggleSolution('sol_doc_3')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_doc_3" class="solution"><div class="code-block"><pre><code><span class="py-keyword">def</span> <span class="py-function">addition</span>(<span class="py-variable">a</span>, <span class="py-variable">b</span>):
...
<span class="py-function">print</span>(<span class="py-string">f"Nouvelle liste triée : {<span class="py-variable">nombres_tries</span>}"</span>) <span class="py-comment"># Output: [1, 2, 5, 8]</span></code></pre></div></div>
        ...
        <div id="exercices-listes" class="mt-16"><h3 class="text-2xl font-semibold mb-4">Série d'Exercices sur les Listes</h3><div class="space-y-6">
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 1 : Créer et Afficher une Liste</h4><p class="text-gray-700 mb-4">Créez une liste appelée <code>fruits_preferes</code> contenant au moins 3 de vos fruits préférés. Affichez la liste entière, puis le premier fruit, et enfin le dernier fruit.</p><button hidden  onclick="toggleSolution('sol_list_1')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_list_1" class="solution"><div class="code-block"><pre><code><span class="py-variable">fruits_preferes</span> <span class="py-operator">=</span> [<span class="py-string">"Pomme"</span>, <span class="py-string">"Mangue"</span>, <span class="py-string">"Fraise"</span>, <span class="py-string">"Raisin"</span>]
...
<span class="py-function">print</span>(<span class="py-string">f"Mon dernier fruit : {<span class="py-variable">fruits_preferes</span>[-<span class="py-number">1</span>]}"</span>)</code></pre></div></div></div>
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 2 : Modifier une Liste</h4><p class="text-gray-700 mb-4">En utilisant la liste <code>fruits_preferes</code> de l'exercice précédent, ajoutez un nouveau fruit à la fin, insérez un fruit à la deuxième position, puis supprimez le fruit à la troisième position.</p><button hidden  onclick="toggleSolution('sol_list_2')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_list_2" class="solution"><div class="code-block"><pre><code><span class="py-variable">fruits_preferes</span> <span class="py-operator">=</span> [<span class="py-string">"Pomme"</span>, <span class="py-string">"Mangue"</span>, <span class="py-string">"Fraise"</span>, <span class="py-string">"Raisin"</span>]
...
<span class="py-function">print</span>(<span class="py-string">f"Après pop : {<span class="py-variable">fruits_preferes</span>}"</span>)</code></pre></div></div></div>
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 3 : Calculer la Moyenne</h4><p class="text-gray-700 mb-4">Écrivez une fonction <code>calculer_moyenne</code> qui prend une liste de nombres et retourne leur moyenne. Si la liste est vide, elle doit retourner 0.</p><button hidden  onclick="toggleSolution('sol_list_3')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_list_3" class="solution"><div class="code-block"><pre><code><span class="py-keyword">def</span> <span class="py-function">calculer_moyenne</span>(<span class="py-variable">liste_nombres</span>):
...
<span class="py-function">print</span>(<span class="py-function">calculer_moyenne</span>([])) <span class="py-comment"># Devrait afficher 0</span></code></pre></div></div></div>
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 4 : Filtrer les Nombres Pairs</h4><p class="text-gray-700 mb-4">Écrivez une fonction <code>filtrer_pairs</code> qui prend une liste de nombres entiers et retourne une nouvelle liste contenant uniquement les nombres pairs.</p><button hidden  onclick="toggleSolution('sol_list_4')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_list_4" class="solution"><div class="code-block"><pre><code><span class="py-keyword">def</span> <span class="py-function">filtrer_pairs</span>(<span class="py-variable">liste_entiers</span>):
...
<span class="py-function">print</span>(<span class="py-function">filtrer_pairs</span>([<span class="py-number">7</span>, <span class="py-number">9</span>, <span class="py-number">11</span>])) <span class="py-comment"># Devrait afficher []</span></code></pre></div></div></div>
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 5 : Inverser une Liste</h4><p class="text-gray-700 mb-4">Créez une fonction <code>inverser_liste</code> qui prend une liste et retourne une nouvelle liste avec les éléments dans l'ordre inverse.</p><button hidden  onclick="toggleSolution('sol_list_5')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_list_5" class="solution"><div class="code-block"><pre><code><span class="py-keyword">def</span> <span class="py-function">inverser_liste</span>(<span class="py-variable">ma_liste</span>):
...
<span class="py-function">print</span>(<span class="py-string">f"Dépaquetage : x={<span class="py-variable">x</span>}, y={<span class="py-variable">y</span>}, z={<span class="py-variable">z</span>}"</span>)</code></pre></div></div>
        ...
        <div id="exercices-tuples" class="mt-16"><h3 class="text-2xl font-semibold mb-4">Série d'Exercices sur les Tuples</h3><div class="space-y-6">
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 1 : Créer et Afficher un Tuple</h4><p class="text-gray-700 mb-4">Créez un tuple <code>informations_livre</code> contenant le titre, l'auteur et l'année de publication d'un livre. Affichez chaque information séparément.</p><button hidden  onclick="toggleSolution('sol_tuple_1')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_tuple_1" class="solution"><div class="code-block"><pre><code><span class="py-variable">informations_livre</span> <span class="py-operator">=</span> (<span class="py-string">"Le Seigneur des Anneaux"</span>, <span class="py-string">"J.R.R. Tolkien"</span>, <span class="py-number">1954</span>)
...
<span class="py-function">print</span>(<span class="py-string">f"Composante Bleue : {<span class="py-variable">b</span>}"</span>)</code></pre></div></div></div>
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 3 : Fusion de Tuples</h4><p class="text-gray-700 mb-4">Créez deux tuples, <code>tuple_a</code> avec (1, 2) et <code>tuple_b</code> avec (3, 4). Concaténez-les pour former un nouveau tuple et affichez-le.</p><button hidden  onclick="toggleSolution('sol_tuple_3')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_tuple_3" class="solution"><div class="code-block"><pre><code><span class="py-variable">tuple_a</span> <span class="py-operator">=</span> (<span class="py-number">1</span>, <span class="py-number">2</span>)
...
<span class="py-function">print</span>(<span class="py-string">f"Tuple fusionné : {<span class="py-variable">tuple_fusionne</span>}"</span>) <span class="py-comment"># Devrait afficher (1, 2, 3, 4)</span></code></pre></div></div></div>
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 4 : Compter les Occurrences</h4><p class="text-gray-700 mb-4">Créez un tuple <code>nombres_tuple</code> avec des nombres répétés (par exemple (1, 2, 2, 3, 1, 4)). Utilisez la méthode <code>count()</code> pour compter combien de fois le nombre 1 apparaît.</p><button hidden  onclick="toggleSolution('sol_tuple_4')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_tuple_4" class="solution"><div class="code-block"><pre><code><span class="py-variable">nombres_tuple</span> <span class="py-operator">=</span> (<span class="py-number">1</span>, <span class="py-number">2</span>, <span class="py-number">2</span>, <span class="py-number">3</span>, <span class="py-number">1</span>, <span class="py-number">4</span>)
...
<span class="py-function">print</span>(<span class="py-string">f"Capitale de l'Italie : {<span class="py-variable">capitale_pays</span>.<span class="py-function">get</span>(<span class="py-string">"Italie"</span>, <span class="py-string">"Non trouvée"</span>)}"</span>)</code></pre></div></div></div>
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 2 : Mettre à Jour un Dictionnaire</h4><p class="text-gray-700 mb-4">En utilisant le dictionnaire <code>capitale_pays</code>, ajoutez "Italie" avec "Rome" comme capitale. Modifiez la capitale de l'Allemagne en "Bonn" (juste pour l'exercice !) puis supprimez l'Espagne.</p><button hidden  onclick="toggleSolution('sol_dict_2')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_dict_2" class="solution"><div class="code-block"><pre><code><span class="py-variable">capitale_pays</span> <span class="py-operator">=</span> {
    <span class="py-string">"France"</span>: <span class="py-string">"Paris"</span>,
    <span class="py-string">"Allemagne"</span>: <span class="py-string">"Berlin"</span>,
    <span class="py-string">"Espagne"</span>: <span class="py-string">"Madrid"</span>
}
...
<span class="py-function">print</span>(<span class="py-string">f"Après suppression Espagne : {<span class="py-variable">capitale_pays</span>}"</span>)</code></pre></div></div></div>
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 3 : Parcourir un Dictionnaire</h4><p class="text-gray-700 mb-4">Créez un dictionnaire <code>inventaire</code> avec des articles et leur quantité (ex: <code>{"pommes": 50, "bananes": 30, "oranges": 70}</code>). Parcourez le dictionnaire et affichez chaque article et sa quantité de la manière suivante : "Il y a X [article] en stock."</p><button hidden  onclick="toggleSolution('sol_dict_3')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_dict_3" class="solution"><div class="code-block"><pre><code><span class="py-variable">inventaire</span> <span class="py-operator">=</span> {<span class="py-string">"pommes"</span>: <span class="py-number">50</span>, <span class="py-string">"bananes"</span>: <span class="py-number">30</span>, <span class="py-string">"oranges"</span>: <span class="py-number">70</span>}
<span class="py-keyword">for</span> <span class="py-variable">article</span>, <span class="py-variable">quantite</span> <span class="py-keyword">in</span> <span class="py-variable">inventaire</span>.<span class="py-function">items</span>():
    <span class="py-function">print</span>(<span class="py-string">f"Il y a {<span class="py-variable">quantite</span>} {<span class="py-variable">article</span>} en stock."</span>)</code></pre></div></div></div>
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 4 : Compter les Fréquences</h4><p class="text-gray-700 mb-4">Écrivez une fonction <code>compter_frequences</code> qui prend une liste de mots et retourne un dictionnaire où les clés sont les mots et les valeurs sont le nombre de fois où chaque mot apparaît dans la liste.</p><button hidden  onclick="toggleSolution('sol_dict_4')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_dict_4" class="solution"><div class="code-block"><pre><code><span class="py-keyword">def</span> <span class="py-function">compter_frequences</span>(<span class="py-variable">liste_mots</span>):
...
<span class="py-function">print</span>(<span class="py-function">compter_frequences</span>(<span class="py-variable">mots</span>)) <span class="py-comment"># Devrait afficher {'pomme': 3, 'banane': 2, 'orange': 1}</span></code></pre></div></div></div>
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 5 : Fusionner deux Dictionnaires</h4><p class="text-gray-700 mb-4">Créez deux dictionnaires <code>dict1</code> et <code>dict2</code>. Fusionnez-les en un nouveau dictionnaire <code>dict_fusionne</code>. Si une clé est présente dans les deux dictionnaires, la valeur du second dictionnaire doit être conservée.</p><button hidden  onclick="toggleSolution('sol_dict_5')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_dict_5" class="solution"><div class="code-block"><pre><code><span class="py-variable">dict1</span> <span class="py-operator">=</span> {<span class="py-string">"a"</span>: <span class="py-number">1</span>, <span class="py-string">"b"</span>: <span class="py-number">2</span>}
...
<span class="py-function">print</span>(<span class="py-string">f"Liste sans doublons : {<span class="py-variable">liste_sans_doublons</span>}"</span>) <span class="py-comment"># L'ordre peut varier</span></code></pre></div></div></div>
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 2 : Éléments Communs</h4><p class="text-gray-700 mb-4">Vous avez deux listes de participants à des événements. <code>participants_a = ["Alice", "Bob", "Charlie", "David"]</code> et <code>participants_b = ["Charlie", "Eve", "Frank", "David"]</code>. Trouvez et affichez les participants qui sont inscrits aux deux événements.</p><button hidden  onclick="toggleSolution('sol_set_2')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_set_2" class="solution"><div class="code-block"><pre><code><span class="py-variable">participants_a</span> <span class="py-operator">=</span> [<span class="py-string">"Alice"</span>, <span class="py-string">"Bob"</span>, <span class="py-string">"Charlie"</span>, <span class="py-string">"David"</span>]
...
<span class="py-function">print</span>(<span class="py-string">f"Participants communs aux deux événements : {<span class="py-variable">communs</span>}"</span>) <span class="py-comment"># Devrait afficher {'Charlie', 'David'}</span></code></pre></div></div></div>
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 3 : Éléments Uniques au Total</h4><p class="text-gray-700 mb-4">En utilisant les mêmes listes de participants que l'exercice précédent, trouvez et affichez tous les participants uniques (sans doublons) présents dans l'un ou l'autre des événements.</p><button hidden  onclick="toggleSolution('sol_set_3')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_set_3" class="solution"><div class="code-block"><pre><code><span class="py-variable">participants_a</span> <span class="py-operator">=</span> [<span class="py-string">"Alice"</span>, <span class="py-string">"Bob"</span>, <span class="py-string">"Charlie"</span>, <span class="py-string">"David"</span>]
<span class="py-variable">participants_b</span> <span class="py-operator">=</span> [<span class="py-string">"Charlie"</span>, <span class="py-string">"Eve"</span>, <span class="py-string">"Frank"</span>, <span class="py-string">"David"</span>]
...
<span class="py-function">print</span>(<span class="py-string">f"Tous les participants uniques : {<span class="py-variable">tous_uniques</span>}"</span>) <span class="py-comment"># Devrait afficher {'Alice', 'Bob', 'Charlie', 'David', 'Eve', 'Frank'}</span></code></pre></div></div></div>
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 4 : Différence de Groupes</h4><p class="text-gray-700 mb-4">Un groupe d'étudiants suit le cours de Python : <code>{'Alice', 'Bob', 'Charlie'}</code>. Un autre groupe suit le cours de Java : <code>{'Charlie', 'David', 'Eve'}</code>. Trouvez et affichez les étudiants qui suivent Python mais pas Java.</p><button hidden  onclick="toggleSolution('sol_set_4')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_set_4" class="solution"><div class="code-block"><pre><code><span class="py-variable">etudiants_python</span> <span class="py-operator">=</span> {<span class="py-string">'Alice'</span>, <span class="py-string">'Bob'</span>, <span class="py-string">'Charlie'</span>}
...
<span class="py-function">print</span>(<span class="py-string">f"Étudiants qui suivent Python mais pas Java : {<span class="py-variable">seulement_python</span>}"</span>) <span class="py-comment"># Devrait afficher {'Alice', 'Bob'}</span></code></pre></div></div></div>
            <div class="bg-white p-6 rounded-lg shadow-sm border"><h4 class="text-lg font-semibold text-gray-900 mb-2">Exercice 5 : Vérifier si un mot est un anagramme</h4><p class="text-gray-700 mb-4">Écrivez une fonction <code>sont_anagrammes</code> qui prend deux chaînes de caractères et retourne <code>True</code> si elles sont des anagrammes l'une de l'autre (utilisez les sets pour cela), <code>False</code> sinon. Les espaces et la casse doivent être ignorés.</p><button hidden  onclick="toggleSolution('sol_set_5')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition-colors">Afficher la solution</button><div id="sol_set_5" class="solution"><div class="code-block"><pre><code><span class="py-keyword">def</span> <span class="py-function">sont_anagrammes</span>(<span class="py-variable">mot1</span>, <span class="py-variable">mot2</span>):
